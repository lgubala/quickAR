...
import ok.jep.renderer.SampleApplicationControl;
import ok.jep.renderer.SampleApplicationException;
import ok.jep.renderer.SampleApplicationSession;
import ok.jep.arstuff.LoadingDialogHandler;
import ok.jep.arstuff.SampleApplicationGLView;
import ok.jep.arstuff.Texture;
import ok.jep.utils.PermissionUtils;

// The main activity for the SampleActivity sample.
public class SampleActivity extends Activity implements SampleApplicationControl, RenderListener {
    ...
    private RelativeLayout mUILayout, clickLayout;
    private FrameLayout ltLogo, ltArrow;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (PermissionUtils.hasGrantedPermissions(SampleActivity.this, true)) {
    ...
    private void findViews() {
        ...
        clickLayout = (RelativeLayout) findViewById(R.id.ltClick);

        ltLogo = (FrameLayout) findViewById(R.id.ltLogo);
        ltArrow = (FrameLayout) findViewById(R.id.ltArrow);
        ...
        clickLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mRenderer != null) {
                    boolean result = mRenderer.jumpToNext();
                    if (!result) {
                        finish();
                    }
                }
    ...
    private void startApp() {
        ...
        System.out.println("### StartAPp " + (vuforiaAppSession != null));
    ...
    @Override
    public void displayArrow(final int id) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ltArrow.setVisibility(View.VISIBLE);
                if (id == 0) {
                    imgCountDown.setImageResource(R.drawable.app_countdown_1);
                } else if (id == 1) {
                    imgCountDown.setImageResource(R.drawable.app_countdown_2);
                } else if (id == 2) {
                    imgCountDown.setImageResource(R.drawable.app_countdown_3);
                }
            }
        });
    }
    ...
    public void hideArrow() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ltArrow.setVisibility(View.GONE);
            }
        });
    }
    ...
    {
        //TODO fix
        mTextures.add(Texture.loadTextureFromApk("ridinghood_1.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("ridinghood_2.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("ridinghood_3.png", getAssets()));
        //mTextures.add(Texture.loadTextureFromApk("TextureBowlAndSpoon.png", getAssets()));
    }
    ...
    private void startLoadingAnimation()
    {
        ...
        /*clickLayout = (RelativeLayout) inflater.inflate(R.layout.camera_overlay, null, false);
        clickLayout.setBackgroundColor(0x00000000);
        clickLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean result = mRenderer.jumpToNext();
        ...
        addContentView(clickLayout, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));*/
    }
    ...
    private void initApplicationAR()
    {
        ...
        if (vuforiaAppSession != null) {
            mRenderer = new ImageRenderer(this, vuforiaAppSession, this);
